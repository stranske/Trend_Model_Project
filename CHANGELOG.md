...
### Removed
- Removed the obsolete `portfolio_analysis_report.py`,
  `manager_attribution_analysis.py`, and `demo_turnover_cap.py` entry points;
  their supported behavior is owned by the unified `trend` CLI (Issue #1437).
