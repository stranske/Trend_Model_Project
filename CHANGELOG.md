...
- Reusable `agents-44-verify-agent-assignment.yml` workflow that checks `agent:codex` issues for valid automation assignees and emits markdown summaries, available via manual dispatch or reusable calls (Issue #2386).
