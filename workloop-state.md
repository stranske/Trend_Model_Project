...
- Current state: ready to commit, push, and open a ready-for-review PR with `agent:codex`, `agents:keepalive`, and `autofix`; post-open action is to verify cap-health/Gate Followups evidence and then leave CI iteration to keepalive.
