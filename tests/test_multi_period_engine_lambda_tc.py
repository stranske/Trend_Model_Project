...
def test_lambda_tc_penalty_reduces_turnover() -> None:
    ...
    base = mp_engine._apply_turnover_penalty(target_weights, prev_weights, 0.0, 0.0, 1.0)
    medium = mp_engine._apply_turnover_penalty(target_weights, prev_weights, 0.5, 0.0, 1.0)
    high = mp_engine._apply_turnover_penalty(target_weights, prev_weights, 0.9, 0.0, 1.0)
