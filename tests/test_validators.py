...
class TestValidateReturnsSchema:
    ...
    def test_no_numeric_columns(self):
        ...
        result = validate_returns_schema(df)
        assert not result.is_valid
        assert "No numeric return columns found (only Date column present)" in result.issues
    ...
    def test_warnings_for_missing_values(self):
        ...
        fund1_data = [0.01, 0.01, 0.01, 0.01, 0.01, None, None, None, None, None, None, None]  # 5/12 valid (~42%)
