...
def test_load_scenario_accepts_null_return_model(tmp_path: Path) -> None:
    base_config = tmp_path / "base.yml"
    base_config.write_text("{}", encoding="utf-8")
...
def test_load_scenario_accepts_null_folds(tmp_path: Path) -> None:
    base_config = tmp_path / "base.yml"
    base_config.write_text("{}", encoding="utf-8")
...
def test_load_scenario_accepts_null_folds_mapping(tmp_path: Path) -> None:
    base_config = tmp_path / "base.yml"
    base_config.write_text("{}", encoding="utf-8")
    scenario_path = tmp_path / "null_folds.yml"
    scenario_path.write_text(
...
def test_load_scenario_accepts_null_return_model_mapping(tmp_path: Path) -> None:
    base_config = tmp_path / "base.yml"
    base_config.write_text("{}", encoding="utf-8")
