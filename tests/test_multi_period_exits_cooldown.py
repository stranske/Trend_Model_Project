...
def _patch_pipeline_capture(
    ...
    *,
    ...
    def fake_pipeline(*_args: Any, **kwargs: Any) -> DiagnosticResult[dict[str, Any] | None]:
        ...
        weights = {str(f): 1.0 / len(manual_funds) for f in manual_funds} if manual_funds else {}
        payload = {
