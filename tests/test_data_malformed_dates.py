...
class TestDataLoadingMalformedDates:
    ...
    def test_load_csv_with_malformed_dates_returns_none(self):
        """Test that load_csv returns None when malformed dates are encountered."""
        ...
        try:
            ...
            assert result is None, "load_csv should return None for files with malformed dates"
        finally:
    ...
    def test_ensure_datetime_handles_already_datetime_column(self):
        """Test that ensure_datetime handles columns that are already datetime."""
