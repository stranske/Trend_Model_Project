...
# Stdlib modules that don't need to be installed. Use the runtime inventory
# when available so newly scanned stdlib imports are not mistaken for packages.
...
def test_lockfile_is_present() -> None:
    ...
    assert lines[0].startswith("# This file was autogenerated by uv"), (
