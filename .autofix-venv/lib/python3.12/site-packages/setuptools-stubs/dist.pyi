...
class Distribution(_Distribution):
    ...
    def fetch_build_eggs(
        self, requires: str | Iterable[str]
    ...
    def get_command_obj(
        self, command: Literal["alias"], create: Literal[1, True] = 1
    ) -> alias: ...
    @overload
    def get_command_obj(
    ...
    def get_command_class(
        self, command: Literal["bdist_wheel"]
    ) -> type[bdist_wheel]: ...
    @overload
    ...
    @overload
    def get_command_class(
        self, command: Literal["easy_install"]
    ) -> type[easy_install]: ...
    @overload
    def get_command_class(
        self, command: Literal["editable_wheel"]
    ) -> type[editable_wheel]: ...
    @overload
