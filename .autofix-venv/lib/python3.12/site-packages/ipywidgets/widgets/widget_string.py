...
class LabelStyle(_StringStyle):
    ...
    font_family = Unicode(None, allow_none=True, help="Label text font family.").tag(
        sync=True
    )
    font_style = Unicode(None, allow_none=True, help="Label text font style.").tag(
        sync=True
    )
    font_variant = Unicode(None, allow_none=True, help="Label text font variant.").tag(
        sync=True
    )
    font_weight = Unicode(None, allow_none=True, help="Label text font weight.").tag(
        sync=True
    )
    text_decoration = Unicode(None, allow_none=True, help="Label text decoration.").tag(
        sync=True
    )
