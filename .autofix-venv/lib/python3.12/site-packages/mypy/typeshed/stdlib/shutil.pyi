...
if sys.version_info >= (3, 8):
    ...
    def copyfileobj(
        fsrc: SupportsRead[AnyStr], fdst: SupportsWrite[AnyStr], length: int = 16384
    ) -> None: ...
...
if sys.version_info >= (3, 8):
    ...
    @overload
    def which(
        cmd: bytes, mode: int = 1, path: StrPath | None = None
    ) -> bytes | None: ...
...
if sys.version_info >= (3, 8):
    ...
    def unpack_archive(
        filename: StrPath, extract_dir: StrPath | None = None, format: str | None = None
    ) -> None: ...
