...
class DescriptorProto(google___protobuf___message___Message):
    ...
    class ReservedRange(google___protobuf___message___Message):
        ...
        def HasField(
            self,
            field_name: typing_extensions___Literal["end", b"end", "start", b"start"],
        ) -> builtin___bool: ...
        def ClearField(
            self,
            field_name: typing_extensions___Literal["end", b"end", "start", b"start"],
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal["name", b"name", "options", b"options"],
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
...
class EnumValueOptions(google___protobuf___message___Message):
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["deprecated", b"deprecated"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "deprecated", b"deprecated", "uninterpreted_option", b"uninterpreted_option"
        ],
    ) -> None: ...
...
class MethodOptions(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "deprecated", b"deprecated", "idempotency_level", b"idempotency_level"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class GeneratedCodeInfo(google___protobuf___message___Message):
    ...
    def ClearField(
        self, field_name: typing_extensions___Literal["annotation", b"annotation"]
    ) -> None: ...
