...
class int:
    ...
    def __new__(
        cls: Type[_T],
        x: Union[str, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...,
    ) -> _T: ...
    @overload
    def __new__(cls: Type[_T], x: Union[str, bytes, bytearray], base: int) -> _T: ...
    @overload
    def __init__(
        self, x: Union[str, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...
    ) -> _T: ...
    @overload
...
class str(Sequence[str]):
    ...
    def find(
        self, sub: str, __start: Optional[int] = ..., __end: Optional[int] = ...
    ) -> int: ...
...
@overload
def max(
    __iterable: Iterable[_T1], *, key: Callable[[_T1], SupportsLessThanT], default: _T2
) -> Union[_T1, _T2]: ...
@overload
def min(
    __arg1: SupportsLessThanT,
