...
### Discovery
- [x] Review consolidated CI orchestrator and Docker workflows to capture the current required job manifest (`.github/workflows/pr-10-ci-python.yml`, `maint-45-verify-ci-stack.yml`, `pr-18-gate-orchestrator.yml`, `pr-12-docker-smoke.yml`).
