...
- Preserve existing orchestrator watchdog behaviour by validating the `enable_watchdog: true` path within `agents-70-orchestrator.yml` and its reusable dependencies (`reuse-agents.yml`).
