...
## Task List
- [x] Audit automerge and supporting workflows to confirm they enforce the label and status rules from Issue #1667 (`.github/workflows/maint-46-merge-manager.yml`).
...
- **Relevant workflow files:**
  ...
  - `.github/workflows/maint-46-merge-manager.yml` (automerge orchestration)
- **Labels involved:**
