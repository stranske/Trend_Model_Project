...
- [x] Remove duplicate coverage publishing from the Gate summary job and ensure scheduled coverage guard jobs auto-detect the new artifact layout.
...
- [x] Adjust the Gate summary job to download the Gate-produced coverage bundle instead of generating a replacement artifact.
