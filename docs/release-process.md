...
The release workflow (`.github/workflows/maint-50-release.yml`) can be triggered in two ways:
...
gh workflow run maint-50-release.yml -f tag=v0.1.0-test -f dry_run=true
```
