...
- **Legacy consumer wrappers:** Former manual shims remain retired. Their history and verification notes are tracked in [ARCHIVE_WORKFLOWS.md](../../ARCHIVE_WORKFLOWS.md); automation must call the orchestrator instead.
