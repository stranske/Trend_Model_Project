...
## Progress
39/39 tasks complete (re-verified 2026-02-05 via `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`; breach direction and empty threshold list checks added).
