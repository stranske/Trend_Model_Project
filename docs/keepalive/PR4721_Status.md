...
Checklist reconciled on 2026-02-05 after adding percent-string and empty-string quantile coverage and verifying per-strategy path exports with `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding summary-quantile column coverage. Re-verified on 2026-02-05 after adding all-non-finite expected shortfall coverage. Re-verified on 2026-02-05 after adding all-non-finite quantile coverage for per-metric path counts. Re-verified on 2026-02-05 after excluding pooled summary columns (`paths`, `folds`) from metric aggregation and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding all-non-finite quantile coverage for all metrics and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding fractional quantile summary coverage and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding breach-spec None coverage and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding summary-quantiles NaN guard coverage and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding percent-threshold breach coverage and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after aligning aggregation row schemas with `fold_id` columns and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding summary-frame coverage for ignoring `paths`/`folds` columns and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after ensuring export path summaries fall back to `strategy_name` and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after filling missing `strategy` values from `strategy_name` in path aggregation and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after filtering unsupported parquet exports and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after adding multi-metric quantile coverage and running `pytest tests/monte_carlo/test_aggregator.py -m "not slow"`. Re-verified on 2026-02-05 after excluding `paths`/`folds` from summary metrics and running `pytest tests/monte_carlo/test_results.py -m "not slow"`. Re-verified on 2026-02-05 after aligning summary metrics with numeric string coercion and running `pytest tests/monte_carlo/test_results.py tests/monte_carlo/test_aggregator.py -m "not slow"`.
