...
Additional verification on 2026-02-04 after extending diagnostics coverage:
`pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"` and
`pytest tests/app/test_nl_operation_viewer_component.py -m "not slow"`.
...
`pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after adding evaluation-field diagnostics coverage and running
`pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after extending diagnostics binding coverage and running
`pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after expanding scalar binding diagnostics coverage and running
`pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after adding evaluation-field scalar binding diagnostics coverage and running
`pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after extending diagnostics coverage for evaluation-only binding indicators and running
`pytest tests/monte_carlo/test_results.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after adding evaluation-binding diagnostics coverage and running
`pytest tests/monte_carlo/test_results.py -m "not slow"`.
Checklist reconciled on 2026-02-05 after validating realized turnover diagnostics and Streamlit
redaction coverage and running `pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"`
and `pytest tests/app/test_nl_operation_viewer_component.py -m "not slow"`.
