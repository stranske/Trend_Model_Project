...
Checklist reconciled on 2026-02-04 after reviewing recent commits and running `pytest tests/monte_carlo/test_runner_turnover_diagnostics.py -m "not slow"` (including the risk_diagnostics turnover case) and `pytest tests/test_config_turnover_validation.py -m "not slow"`.
