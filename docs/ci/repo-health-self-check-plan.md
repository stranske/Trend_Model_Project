...
- **Archival requirement:** Retire experimental self-test workflows (`selftest-83-…`, `selftest-84-…`, `selftest-88-…`, `selftest-81-…`, `selftest-82-…`) by moving them under `Old/` (or removing them) and document their archival location in `ARCHIVE_WORKFLOWS.md` plus `docs/ci/WORKFLOWS.md`.
