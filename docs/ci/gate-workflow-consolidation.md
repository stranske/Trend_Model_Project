...
- [x] Verify `.github/workflows/pr-gate.yml` invokes the reusable CI and Docker composites for Python 3.11, Python 3.12, and the smoke test, with results collated under the `gate` job.
