...
3. Maintenance workflows that trigger on `workflow_run` events (`maint-30-post-ci.yml`, `maint-33-check-failure-tracker.yml`, and similar listeners) monitor `Gate` exclusively.
