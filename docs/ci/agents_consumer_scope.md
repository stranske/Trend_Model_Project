...
1. Navigate to **Actions → Agents 61 Consumer Compat → Run workflow**.
...
The workflow enforces a concurrency group of `agents-61-consumer-compat-${ref_name}`. Triggering
