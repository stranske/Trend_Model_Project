...
def _is_mock_streamlit(module: Any) -> bool:
    """Return True when Streamlit has been patched with ``MagicMock`` for tests."""
...
def _summarise_multi(results: List[Dict[str, Any]]) -> pd.DataFrame:
    ...
    for r in results:
        ...
        rows.append(
            {
                "in_start": _period_val(0),
                "in_end": _period_val(1),
                "out_start": _period_val(2),
                "out_end": _period_val(3),
