...
This module provides a FastAPI-based health check endpoint that can be used
for Docker health checks, load balancer health checks, and CI/CD pipelines.
It serves as a lightweight alternative to the full Streamlit app for health monitoring.
"""
