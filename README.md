...
The PR runner lives in `.github/workflows/autofix.yml` while post-CI follow-up continues to run via `maint-46-post-ci.yml`, both delegating to the shared reusable autofix composite.
