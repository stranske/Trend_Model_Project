...
| `trend_analysis/io/market_data.py` | 100% |
| `trend_analysis/signal_presets.py` | 100% |
| `trend_analysis/util/frequency.py` | 100% |
| `trend_analysis/signals.py` | 100% |
| `trend_analysis/backtesting/bootstrap.py` | 100% |
| `trend_analysis/risk.py` | 100% |
| `trend_analysis/export/bundle.py` | 99% |
| `trend_analysis/cli.py` | 99% |
| `trend_analysis/engine/optimizer.py` | 100% |
| `trend_analysis/config/model.py` | 99% |
| `trend_portfolio_app/monte_carlo/engine.py` | 100% |
