...
- (2026-11-12) Issue #2656 completion audit verified README.md, CONTRIBUTING.md, `docs/ci/WORKFLOWS.md`, and `docs/ci/WORKFLOW_SYSTEM.md` all route readers through the overview first and that references to retired workflows remain confined to this archive.
