...
def create_test_scenarios():
    ...
    scenarios['well_conditioned'] = pd.DataFrame([
        ...
        [0.002, 0.09, 0.003],
        [0.001, 0.003, 0.16]
    ], index=['Asset_A', 'Asset_B', 'Asset_C'], columns=['Asset_A', 'Asset_B', 'Asset_C'])
...
def demonstrate_robust_weighting():
    ...
    engines_to_test = [
        ('robust_mv', {'shrinkage_method': 'ledoit_wolf', 'condition_threshold': 1e10, 'safe_mode': 'hrp'}),
        ('robust_mv', {'shrinkage_method': 'oas', 'condition_threshold': 1e8, 'safe_mode': 'risk_parity'}),
