...
- Use the [agent task issue template](.github/ISSUE_TEMPLATE/agent-task.md) when queuing Codex automation so goals, constraints, outputs, and success criteria are captured up front.
