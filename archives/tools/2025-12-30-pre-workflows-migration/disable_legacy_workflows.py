...
CANONICAL_WORKFLOW_NAMES: set[str] = {
    ...
    "Agents Moderate Connector Comments",
    ...
    "Maint 52 Validate Workflows",
    "Maint 60 Release",
    "Maint Coverage Guard",
    "PR 11 - Minimal invariant CI",
    "PR 12 - Fund selector Playwright smoke",
